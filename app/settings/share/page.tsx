    ...
    <AppShell>
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Share Portfolio</h1>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          {isExpired && (
                            <span className="text-xs text-gray-500 bg-gray-700 px-2 py-0.5 rounded-full flex-shrink-0">
                              Expired
                            </span>
                          )}
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-red-400 bg-gray-800 hover:bg-red-950/30 rounded-lg transition-colors"
                          title="Delete link"
                        >
