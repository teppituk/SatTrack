# StackSat — Deploy Prompt (พร้อมก๊อปไปวางใช้ครั้งหน้า)
...
```
ช่วย deploy แอป StackSat (Next.js 15 + Prisma + BullMQ worker) ขึ้น AWS ตามสเปกนี้ทั้งหมด ทำให้จบและทดสอบให้เข้าได้จริง:
